 ...
 */
Ext.ns('Ext.ijobs.task.TempScriptAction');
...
Ext.define('Ext.ijobs.task.TempScriptAction', {extend: 'Ext.ijobs.task.TempScriptUI', 
    ...
    initEvents: function() {
        ...
        c.cmbApplication.on('select', this._onApplicationChange, this);        
    ...
    _executeScript: function() {        
        ...
        var txtScriptCode = this.COMPONENTS.txtScriptCode;
        var txtScriptParams = Ext.get('txtScriptArgus');
                ...
                if (this.toolkit.hasPermission(response)) {
                    ...
                    if (result.showInConsole) {
                        ...
                        if (result.taskId > 0) {
                            ...
                            openNewTab("./jobs/jobRun.jsp?jobInstanceId=" + result.taskId, "执行作业【一次性执行脚本】");
