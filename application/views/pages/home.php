			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbar-collapse">
					<ul class="nav navbar-nav">
						...
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">关于我们&nbsp;<i class="fa fa-angle-down"></i></a>
						...
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">产品中心&nbsp;<i class="fa fa-angle-down"></i></a>
							<ul class="dropdown-menu">
								<li><a href="#">试驾基地</a></li>
								<li><a href="#">试驾机械</a></li>
								<li><a href="#">下载中心</a></li>
						...
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">业务范围&nbsp;<i class="fa fa-angle-down"></i></a>
							<ul class="dropdown-menu">
						...
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">成功案例&nbsp;<i class="fa fa-angle-down"></i></a>
							<ul class="dropdown-menu">
						...
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">新闻中心&nbsp;<i class="fa fa-angle-down"></i></a>
							<ul class="dropdown-menu">
								<li><a href="#">企业资讯</a></li>
								<li><a href="#">行业动态</a></li>
								<li><a href="#">活动集锦</a></li>
						...
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">联系我们&nbsp;<i class="fa fa-angle-down"></i></a>
							<ul class="dropdown-menu">
								<li><a href="#">企业版图</a></li>
								<li><a href="#">人才招聘</a></li>
								<li><a href="#">留言板</a></li>
		...
		<figure id="carousel" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner" role="listbox">
				<div class="item active">
					<img src="assets/img/product/ad-01.jpg">
				</div>
				<div class="item">
					<img src="assets/img/product/ad-01.jpg">
				</div>
			...
			<div class="container">
				...
				<div class="base-wrap">
					...
					<div class="section">
						<a class="clearfix base-inner" href="#">
							...
							<div class="base-description">
								<h3 class="base-heading">七星湾试驾基地</h3>
								<p class="text-justify">位于沈阳市浑南新区东湖学校附近，即杨官派出所旁；临近沈抚大道，占地总面积8.5万平方米</p>
							</div>
					...
					<div class="section">
						<a class="clearfix base-inner" href="#">
							<div class="base-photo">
								<img class="img-responsive" src="assets/img/product/base-02.jpg">
							</div>

							<div class="base-description">
								<h3 class="base-heading">广州大观路试驾基地</h3>
								<p class="text-justify">中国首个以汽车培训为主题的汽车基地,广州大观路试驾基地位于广州天河区大观中路，北接广深高速，南接广州中山大道，与广州奥体中心相邻，毗邻航天奇观相邻。试驾基地占地总面积三万多平方米。</p>
							</div>
					...
					<div class="section">
						<a class="clearfix base-inner" href="#">
							<div class="base-photo">
								<img class="img-responsive" src="assets/img/product/base-03.jpg">
							</div>

							<div class="base-description">
								<h3 class="base-heading">苏州阳澄湖试驾基地</h3>
								<p class="text-justify">位于苏州相城区阳澄湖镇凤阳路5号，为全国闻名的大闸蟹产地阳澄湖畔,紧邻千年古刹皇罗禅寺,带私家码头,与阳澄湖水零距离，苏式建筑与苏式水乡风景尽收眼底。</p>
							</div>
					...
					<div class="section">
						<a class="clearfix base-inner" href="#">
							...
							<div class="base-description">
								<h3 class="base-heading">title</h3>
