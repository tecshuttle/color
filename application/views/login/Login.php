			...
			<section class="body login">
				...
				<div class="form-horizontal">
					<div class="form-group">
						...
						<div class="col-xs-9">
							<input type="text" class="form-control input-lg cp-placeholder" placeholder="请输入邮箱/用户名/手机号">
					...
					<div class="form-group">
						...
						<div class="col-xs-9">
							<input type="password" class="form-control input-lg cp-placeholder" placeholder="请输入您的密码">
