...
function set_city(province, city) {
	...
	$.get(page_url, {province: pv, city: cv}, function(res){
		...
		<header class="cp-select select-horizontal">
			<div class="clearfix inner">
				<div class="pull-left select-item">
					<select class="form-control"  id="to_cn" onchange="set_city(this, document.getElementById('city')); WYL();">
						<option value=北京>
							北京
						</option>
						<option value=上海>
